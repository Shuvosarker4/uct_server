...
from users.views import FacultyViewSet,AdminViewSet,AcademicFacultyViewSet
...
router.register('users/create-academic-faculty',AcademicFacultyViewSet,basename='academic-faculties')
